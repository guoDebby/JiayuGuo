...
//	alert(i+","+j+" clicked");
	...
	$('#id' + i + '_' + j).removeClass('Step0');
	$('#id' + i + '_' + j).removeClass('Step1');
	$('#id' + i + '_' + j).removeClass('Step2');
	$('#id' + i + '_' + j).removeClass('Step3');
	
	if(val ==0)
		$('#id' + i + '_' + j).addClass('Step1');
	else if(val ==1)
		$('#id' + i + '_' + j).addClass('Step3');
	else if(val ==2)
		$('#id' + i + '_' + j).addClass('Step0');
	else if(val ==3)
		$('#id' + i + '_' + j).addClass('Step2');
